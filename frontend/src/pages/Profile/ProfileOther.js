...
const ProfileOther = () => {
        ...
        return (
            <div className="min-h-screen bg-[#18191a] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-[#e4e6ea] text-lg">Loading profile...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#18191a]">
            ...
            {/* Cover Photo */}
            <div className="bg-[#242526] border-b border-[#3a3b3c] pb-[1rem]">
                    ...
                    <div className="px-4 sm:px-6 pb-4">
                        <div className="flex flex-col sm:flex-row sm:items-end flex-wrap sm:justify-between gap-4">
                            <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-8 sm:-mt-[5.5rem] sm:flex-wrap sm:gap-x-6 sm:gap-y-2">
                                <div className="relative">
                                    <div className="w-40 h-40 sm:w-44 sm:h-44 rounded-full border-4 border-[#18191a] overflow-hidden bg-[#3a3b3c] shadow-[0_0_0_4px_#242526]">
                                        <img src={user.Avatar} alt="Avatar" className="w-full h-full object-cover" />
                                    </div>
                                </div>
                                <div className="sm:pb-4 min-w-0">
                                    <h1
                                        className="text-[#e4e6ea] text-2xl sm:text-3xl font-bold mb-2 w-fit"
                                    >
                                        {user.Name}
                                    </h1>
                            ...
                            <div className="flex gap-3 sm:pb-4">
                                <button onClick={handleMessageClick} className="px-5 py-2.5 rounded-lg bg-[#2374e1] hover:bg-[#1a62c6] text-white font-semibold shadow transition">
                                    Message
                                </button>
                                {relationshipStatus === "friends" && (
                                    <button
                                        onClick={handleUnfriend}
                                        className="px-5 py-2.5 rounded-lg bg-red-600 hover:bg-red-700 text-white font-semibold border border-[#4e4f50] transition"
                                    >
                                        Unfriend
                                    </button>
                                )}
                                ...
                                {relationshipStatus === "sent" && (
                                    <button
                                        ...
                                        className="px-5 py-2.5 rounded-lg bg-yellow-600 hover:bg-yellow-700 text-white font-semibold border border-[#4e4f50] transition"
                                    >
                                        Cancel Request
                                    </button>
                                )}
                                ...
                                {relationshipStatus === "received" && (
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="px-5 py-2.5 rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold border border-[#4e4f50] transition"
                                        >
                                            Accept
                                        </button>
                                        <button
                                            onClick={handleRejectFriendRequest}
                                            className="px-5 py-2.5 rounded-lg bg-gray-600 hover:bg-gray-700 text-white font-semibold border border-[#4e4f50] transition"
                                        >
                                            Reject
                                        </button>
                                    </div>
                                ...
                                {relationshipStatus === "none" && (
                                    <button
                                        ...
                                        className="px-5 py-2.5 rounded-lg bg-[#3a3b3c] hover:bg-[#4e4f50] text-white font-semibold border border-[#4e4f50] transition"
                                    >
                                        Add Friend
                                    </button>
                                )}
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-2 py-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 bg-[#242526] rounded-xl p-6 shadow-lg h-fit sticky top-24">
                    <h2 className="text-[#e4e6ea] text-2xl font-bold mb-6">About</h2>
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-[#e4e6ea] font-semibold mb-2">📧 Email</h3>
                            <p className="text-[#b0b3b8]">{user.Email}</p>
                        </div>

                        {user.DateOfBirth && (
                            <div>
                                <h3 className="text-[#e4e6ea] font-semibold mb-2">🎂 Date of Birth</h3>
                        ...
                        {user.Bio && (
                            <div>
                                <h3 className="text-[#e4e6ea] font-semibold mb-2">📝 Bio</h3>
